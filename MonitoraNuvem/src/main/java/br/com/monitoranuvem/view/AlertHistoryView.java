 ...
 * @author Cristiano
 */
public class AlertHistoryView extends HttpServlet {
    ...
    protected void processRequest(HttpServletRequest request, HttpServletResponse response)
        ...
        ArrayList<SendAlerts> listaSendAlerts = sac.listaSendAlertsHistory();
        
        session.setAttribute("listaSendAlerts", listaSendAlerts);
        
        RequestDispatcher rd = request
                .getRequestDispatcher("/alerthistory.jsp");
    ...
    protected void doGet(HttpServletRequest request, HttpServletResponse response)
        ...
        try {
            ...
            Logger.getLogger(AlertHistoryView.class.getName()).log(Level.SEVERE, null, ex);
